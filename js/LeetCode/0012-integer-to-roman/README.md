<h2><a href="https://leetcode.com/problems/integer-to-roman/?envType=problem-list-v2&envId=ds0zj9rs">12. Integer to Roman</a></h2><h3>Medium</h3><hr><p>Seven different symbols represent Roman numerals with the following values:</p>
